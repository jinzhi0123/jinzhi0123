...
if (pathName === '/') {
  $(document).ready(function(){
      if ( $("#bber-talk").length > 0 ) {
        var jsonUrl = ''
        jsonUrl = "https://6262-bber-6gm2j5jnd3782d8b-1306507513.tcb.qcloud.la/json/bber.json"
        $.getJSON(jsonUrl+"?t="+Date.parse( new Date()),function(res){
          ...
          $.each(res.data, function(i, item){
            ...
            bberHtml += '<li class="item item-'+(i+1)+'">'+'<a href="https://jinzhi0123.gitee.io/bber" style="color: var(--font-color);/*font-weight: normal;*/">'+newdataTime+'： '+urlToLink(item.content)+'</a></li>'
          });
